...
metadata:
  ...
  source: haex-paperclip:commands/speckit.haex-paperclip.goal.md
---
...
Invoke `.specify/scripts/bash/goal.sh` with the parsed arguments. The script is responsible for:
