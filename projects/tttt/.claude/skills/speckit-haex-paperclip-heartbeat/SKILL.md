...
description: 'Run one heartbeat tick: refresh goals, check budgets, delegate pending
  work'
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: haex-paperclip:commands/speckit.haex-paperclip.heartbeat.md
---

# Paperclip: Heartbeat

A single pulse of the zero-human workflow. Invoke manually, or schedule via
cron/systemd-timer using `.specify/scripts/bash/heartbeat.sh` directly.
