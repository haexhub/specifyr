...
<template>
  ...
  >
    ...
    <!-- Expanded: full list grouped by org. On mobile this is always shown
         regardless of `compact`, since the overlay should show full project
         titles. On desktop, only when not compact. -->
    <nav
